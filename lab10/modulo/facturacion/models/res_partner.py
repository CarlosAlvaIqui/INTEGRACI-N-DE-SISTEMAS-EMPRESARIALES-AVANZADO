...
URL = 'https://www.apisperu.com/api/v1/'
TOKEN = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6ImNhcmxvcy5hbHZhcmV6LmlAdGVjc3VwLmVkdS5wZSJ9.Rdqe4P6kq1O8jMzJPfsef4kzETAjTHm1k7vL1bq76zs'
...
def onchange_doc(self):
    for partner in self:
        ...
        if partner.tipo_doc_id in ('1','6') and partner.vat is not False:
            tipo_doc = False
...
def _check_unique_vat(self):    
    for partner in self:
        ...
        if same_vat_count > 1:
            raise Warning("Ya existe una entodad con ese documento!")
